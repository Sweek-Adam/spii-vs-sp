...
# ---------------------------------------------------------------------
# Double-clique ce fichier (ou clic droit -> "Executer avec PowerShell")
# pour generer le fichier Excel sans taper de commande.
#
...
# Se placer dans le dossier de CE script (a cote de spii_v2.py et config.toml)
...
# --- 1. Verifier la presence de config.toml ---
...
# (extraction ciblee d'une ligne 'python_exe = "..."' ou "'...'")
$python = $null
...
# --- 3. Verifier que le chemin est renseigne et valide ---
...
# Garder la fenetre ouverte pour lire les messages
Write-Host ""
Read-Host "Appuie sur Entree pour fermer"
